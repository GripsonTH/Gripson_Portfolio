  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="m-8 flex items-center justify-center gap-4 text-2xl">
        ...
        <a href="/Gripson_Portfolio/GripsonResume.pdf" download="GripsonResume.pdf">
          <img
            className="w-7 hover:scale-105 hover:rotate-3 hover:opacity-75 transition duration-200"
            src={Resume}
            alt="Resume"
          />
        </a>
